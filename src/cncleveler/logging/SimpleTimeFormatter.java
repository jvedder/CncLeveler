...
public class SimpleTimeFormatter extends Formatter
{
     ...
     */
    private static final String FORMAT = "[%1$td-%1$tb-%1$tY %1$tT] %2$-7s: %3$s%4$s%n";
     ...
     * 
     * <pre>
     *    [20-Oct-2016 13:25:30] INFO   : The application started
     *    [20-Oct-2016 13:25:31] INFO   : This is application status
     *    [20-Oct-2016 13:25:33] WARNING: This is some warning message
     *    [20-Oct-2016 13:28:15] SEVERE : This is a severe message with exception
    ...
    public synchronized String format(LogRecord record)
    {
        ...
        return String.format(FORMAT, timeStamp, record.getLevel().getName(), record.getMessage(), throwable);
    }
}
